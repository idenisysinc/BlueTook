						...
						<div class="card-footer">
							<div class="row">
								...
								<div class="col-lg-8 text-xl-right">
									<button type="button" class="btn bg-grey whatsapp-btn"><img src="assets/images/watsapp-icon-white.png" class="rounded-circle mr-2" width="18" height="18" alt="">Send Whatsapp</button>
