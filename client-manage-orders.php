			...
			<div class="content w-90 m-auto">
				<div class="row">
					<div class="col-lg-3">
						<div class="card filter-sidebar sidebar-link-div border-0">
							<div class="filter-body full-radius5">
								...
								<a href="#" class="dropdown-item active"><i class="icon-clipboard3"></i> Manage Order</a>
					...
					<div class="col-lg-9">
						...
						<div class="row">
							<div class="col-sm-12">
								<h2 class="position-relative text-center title-before title-after cookie-font title-font35">Manage Order</h2>
							</div>	
						</div>
						<!-- /row1 -->
								...
								<div class="row">
									...
									<div class="col-xl-10">
										<div class="media-body">
											<div>
												<h6 class="media-title float-lg-left mb-3 font-weight-semibold">Photography - Wedding</h6>
												<p class="m-0 float-lg-right"><span>100</span> Photos</p>
											</div>
											<p class="text-secondary m-0 clear-both">
												Order Date: <span class="font-weight-semibold">31-Jan-2020</span>
											</p>
											<p class="text-secondary m-0 mb-2 clear-both">
												Event Date: <span class="font-weight-semibold">31-Jan-2020</span>
											</p>
											...
											<p class="m-0"><a href="#" data-toggle="modal" data-target="#modal_large">Write a Review</a></p>
										</div>
									</div>
								</div>
							</div>
							<div class="card-footer">
								<div class="row">
									<div class="col-xl-4 d-flex align-items-center sm-desktop-mb-10">
										<p class="float-left m-0 font-weight-semibold font-16">Amount: Rs. 50000</p>
									</div>
									<div class="col-xl-8 text-xl-right">
										<button type="button" class="btn bg-danger ml-2 sm-desktop-ml-0 px-3"><i class="icon-cross2 mr-2"></i>Cancel Order</button>
									</div>
								</div>
							</div>
						</div>
				...
				<form action="#">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-lg-12">
									<label class="d-block mb-2"><strong>Rating</strong></label>
									<div class="form-group">
										<label class="d-block">Creativity</label>
										<input type="text" class="form-control ion-height-helper" id="ion-basic" data-fouc>
									</div>
									<div class="form-group">
										<label class="d-block">Professionalism</label>
										<input type="text" class="form-control ion-height-helper" id="ion-basic2" data-fouc>
									</div>
									<div class="form-group">
										<label class="d-block">Responsiveness</label>
										<input type="text" class="form-control ion-height-helper" id="ion-basic3" data-fouc>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										<label class="d-block"><strong>Write a Comment</strong> (Max 2000 chars)</label>
										<textarea rows="5" cols="5" class="form-control" placeholder="Write a Comment"></textarea>
									</div>
									<button type="button" class="btn bg-grey gradi-btn px-3 mb-2"><i class="icon-upload mr-2"></i>Upload</button>
								</div>
							</div>
