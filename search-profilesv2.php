		...
		<div class="content-wrapper">
			...
			<div class="content w-90 m-auto">
				<form action="#">
					<div class="row">
						<div class="col-lg-3">
							<div id="filterAraccordion" class="card filter-sidebar border-0">
								<!-- Accordion -->
									<h2 class="text-white px-3 py-2 main-heading mb-0 bord-radius-tp-5">Filters <a data-toggle="collapse"href="#accordion1"><i class="icon-arrow-down22 icon-2x float-right text-white filter-icon"></i></a></h2>
								<!-- /Accordion -->
								<div id="accordion1" class="card-body filter-body collapse show" data-parent="#filterAraccordion">
									<!-- sort -->
						...
						<div class="col-lg-9">
							...
							<div class="row">
								<div class="col-xl-6">
									<div class="card custom-box-shadow bord-radius-tp-5 bord-white-2">
										...
										<div class="card-body mob-text-center">
											<div class="media flex-column flex-md-row m-0">
												<div class="mr-md-3 mb-2 mb-md-0 mob-w-100">
													<img src="assets/images/placeholders/placeholder.jpg" class="rounded-circle img-gry-border" width="80" height="80" alt="">
												</div>

												<div class="media-body">
													<h6 class="mb-0 font-18 blk-lgt-color">James Alexander</h6>
													<p class="xsml-mb"><i class="icon-star-full2 star-rate-on font-size-lg"></i> <i class="icon-star-full2 star-rate-on font-size-lg"></i> <i class="icon-star-full2 star-rate-on font-size-lg"></i> <i class="icon-star-full2 star-rate-off font-size-lg"></i> <i class="icon-star-full2 star-rate-off font-size-lg"></i></p>
													<p class="price-dtls deep-slate-color font-16 mb-xl-0">Starting From <strong class="price">₹12000.00</strong></p>
								    	...
								    	<div class="card-body pt-0 border-0">
								    		<div>
								    			<div class="row d-flex align-items-center text-center">
								    				<div class="col-xl-12 price-rate-btn">
								...
								<div class="col-xl-6">
									<div class="card custom-box-shadow bord-radius-tp-5 bord-white-2">
										<!-- imgSlider -->
										<div id="picSlider2" class="carousel slide carousel-fade div16by9" data-ride="carousel">
											<!-- Indicators -->
											<ul class="carousel-indicators">
											   	<li data-target="#picSlider2" data-slide-to="0" class="active"></li>
											   	<li data-target="#picSlider2" data-slide-to="1"></li>
											   	<li data-target="#picSlider2" data-slide-to="2"></li>
											</ul>
											...
											<!-- Left and right controls -->
											<a class="carousel-control-prev" href="#picSlider2" data-slide="prev">
											    <span class="carousel-control-prev-icon"></span>
											</a>
											<a class="carousel-control-next" href="#picSlider2" data-slide="next">
											    <span class="carousel-control-next-icon"></span>
											</a>
										</div>
										<!-- imgSlider -->
								...
								<div class="col-xl-6">
									<div class="card custom-box-shadow bord-radius-tp-5 bord-white-2">
										<!-- videoSlider -->
										<div id="videoSlider2" class="carousel slide carousel-fade" data-ride="carousel">
											<!-- Indicators -->
											<ul class="carousel-indicators">
											   	<li data-target="#videoSlider2" data-slide-to="0" class="active"></li>
											   	<li data-target="#videoSlider2" data-slide-to="1"></li>
											   	<li data-target="#videoSlider2" data-slide-to="2"></li>
											</ul>
											...
											<!-- Left and right controls -->
											<a class="carousel-control-prev" href="#videoSlider2" data-slide="prev">
											    <span class="carousel-control-prev-icon"></span>
											</a>
											<a class="carousel-control-next" href="#videoSlider2" data-slide="next">
											    <span class="carousel-control-next-icon"></span>
											</a>
										</div>
										<!-- /videoSlider -->
