	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4 class="font-weight-semibold"><i class="icon-briefcase3 mr-2"></i>My Ongoing Work</h4>
					</div>
				</div>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">My Ongoing Work</span>
						</div>
					</div>
			...
			<!-- Content area -->
			<div class="content">
				<div class="w-80 m-auto full-width-mob">
					<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-xl-10">
									<div class="media-body">
										...
										<p class="clear-both">
											<a href="#" class="badge badge-pill bg-blue px-3 font-14 font-weight-normal"><i class="icon-plus-circle2 mr-2"></i>Add to Calendar</a>
										</p>
						...
						<div class="card-footer">
							<div class="row">
								...
								<div class="col-xl-8 text-xl-right">
									<button type="button" class="btn bg-grey sm-tab-mb-5"><i class="icon-checkmark4 mr-2"></i>Mark Completed</button>
									<button type="button" class="btn bg-grey ml-2 sm-mob-cust-ml-0 sm-tab-mb-5" data-toggle="modal" data-target="#modal_large"><i class="icon-images3 mr-2"></i>Create Album</button>
									<button type="button" class="btn bg-grey ml-2 sm-tab-ml-0 dropdown" data-toggle="dropdown"><i class="icon-bubbles2 mr-2"></i>Chat Now</button>
									<!-- chat now dropdown -->
